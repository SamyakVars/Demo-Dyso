...
class lvl1{
    constructor(){
        ...
        this.p1 = new Platform(370, this.h / 1.165, 730, 100)
        this.p2 = new Platform(875, this.h / 1.165, 160, 100)
        this.p3 = new Platform(1090, this.h / 1.205, 155, 150)
        this.p4 = new Platform(1250, this.h / 1.205, 35, 150)
        this.p5 = new Platform(1555, this.h / 1.205, 465, 150)
        this.p6 = new Platform(1865, this.h / 1.205, 35, 150)
        this.p7 = new Platform(2020, this.h / 1.28, 140, 40)
        this.p8 = new Platform(2210, this.h / 1.28, 140, 40)
        this.p9 = new Platform(2355, this.h / 1.205, 35, 150)
        ...
        this.ground = createSprite(960, this.h - this.h / 20, 1920, this.h / 10)
        this.ground.visible = false
        this.level1Group.add(this.ground)


        this.groundCollider = createSprite(960, this.h - this.h / 20 - 3, 1920, this.h / 10)
        ...
        this.lWall = createSprite(-1 * displayWidth / 6.5, this.h, 640, this.h)
        ...
        this.player = new Plr(75, this.h / 1.309, this.pidle, this.panimation, this.pjump, this.pdeath)
        this.level1Group.add(this.player.plr)


        this.storyline = createSprite(549, this.h / 1.5, 1920, this.h / 2)
        ...
        this.gyo1 = new Enemy(2250, this.h / 1.45)
        ...
        this.ob2 = createSprite(980, this.h / 1.15, 50, 50)
        this.ob3 = createSprite(1195, this.h / 1.15, 50, 50)
        this.ob4 = createSprite(1300, this.h / 1.15, 50, 50)
        this.ob5 = createSprite(1810, this.h / 1.15, 50, 50)
        this.ob6 = createSprite(2120, this.h / 1.15, 460, 50)
        this.ob7 = createSprite(2850, this.h / 1.15, 970, 50)
        this.ob8 = createSprite(3565, this.h / 1.4, 40, 40)
        this.ob9 = createSprite(3990, this.h / 1.83, 40, 40)
        ...
        this.leftMove = createSprite(60, this.h / 1.1, 130, 130)
        ...
        this.rightMove = createSprite(160, this.h / 1.1, 130, 130)
        ...
        this.jumpMove = createSprite(this.w / 2 + this.camX / 2.2, this.h / 1.1, 130, 130)
        ...
        this.portal = createSprite(4180, this.h / 2.2, 20, 20)
    ...
    play(){
        ...
        this.lSprite.x = camera.position.x - this.camX / 13
        this.rSprite.x = camera.position.x + this.camX / 13
